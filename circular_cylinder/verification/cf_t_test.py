...
#     criteria = postproc.frequency_spectra.FreqConv(torch=ti[ti > late], u=u[ti > late], n=n, OL=0.5)
#     f, uk = criteria.welch()
...
#
#     ax.plot(window_t, normed_error, length_scale='r')
#     plt.savefig(vtr_file + f"figures/{interest}_converged_{idx}.png", bbox_inches='tight', dpi=600,
#                 transparent=False)
#     plt.close()
