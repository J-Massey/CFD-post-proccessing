...
def main(wd):
    ...
    try:
        model.load_state_dict(torch.load('models/nn_regression.pth'))
    ...
    compare_model(model, poly_n, fn='figures/model_wd_'+str(wd)+'.pdf')

    print("\nBetter?")


if __name__ == "__main__":
    from plot import plot_loss, plot_model
    for w in range(-5, 2):
        main(10**w)
